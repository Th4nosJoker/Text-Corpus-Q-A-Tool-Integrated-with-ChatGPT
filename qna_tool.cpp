...
void QNA_tool::query(string question, string filename){ 
    string API_KEY = "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";
    ...
    string q2_3 = "I feed to you in order to get a very relevant answer. Your answer must be in range 3 - 5 and only respond with a number nothing else.";
